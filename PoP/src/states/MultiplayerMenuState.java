...
public class MultiplayerMenuState extends State{
	...
	public void draw(Graphics2D g) {
		...
		if(currentChoiceP1 == 0 && currentChoiceP2 == 0){
			g.drawImage(p1,Game.WIDTH/2-54-p1.getWidth()/2,Game.HEIGHT/2 + 16,null);
			g.drawImage(p2,Game.WIDTH/2-54+p2.getWidth()/2,Game.HEIGHT/2 + 16,null);
		} else if(currentChoiceP1 == 1 && currentChoiceP2 == 1){
			g.drawImage(p1,Game.WIDTH/2+46-p1.getWidth()/2,Game.HEIGHT/2 + 16,null);
			g.drawImage(p2,Game.WIDTH/2+46+p2.getWidth()/2,Game.HEIGHT/2 + 16,null);
		} 
		
		if(currentChoiceP1 == 0 && currentChoiceP2 != 0){
			g.drawImage(p1,Game.WIDTH/2-50,Game.HEIGHT/2 + 16,null);
		} else if(currentChoiceP1 == 1 && currentChoiceP2 != 1){
			g.drawImage(p1,Game.WIDTH/2+50,Game.HEIGHT/2 + 16,null);
		...
		if(currentChoiceP2 == 0 && currentChoiceP1 != 0){
			g.drawImage(p2,Game.WIDTH/2-52,Game.HEIGHT/2 + 16,null);
		} else if(currentChoiceP2 == 1 && currentChoiceP1 != 1){
			g.drawImage(p2,Game.WIDTH/2+48,Game.HEIGHT/2 + 16,null);
		}
